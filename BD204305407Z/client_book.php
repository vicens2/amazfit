                ...
                <tbody class="text-center">
                  ...
                  ?>
                        ...
                        <tr>
                          ...
                          switch ($estado) {
                            case 'COMPLETED':
                              echo '<td class="d-flex justify-center"><div class="col-12 rounded-100 py-4 col-6 text-center text-14 fw-500 bg-blue-1-05 text-blue-1">Confirmado</div></td>';
                              break;
          ...
          <div class="py-30 px-30 rounded-4 bg-white shadow-3">
            ...
            <div class="tabs -underline-2 js-tabs">
              <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
                ...
                <div class="col-auto">
                  <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button is-tab-el-active" data-tab-target=".-tab-item-1">Todos los pedidos</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button " data-tab-target=".-tab-item-2">Confirmado</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button " data-tab-target=".-tab-item-3">Cancelado</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button " data-tab-target=".-tab-item-5">Preparado</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button " data-tab-target=".-tab-item-5">En Camino</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button " data-tab-target=".-tab-item-5">Entregado</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button " data-tab-target=".-tab-item-6">Devulto</button>
                </div>
                        ...
                        ?>
                              ...
                              <tr>
                                ...
                                switch ($estado) {
                                  ...
                                  case 'CANCELED':
                                    echo '<td class="d-flex justify-center"><div class="col-12 rounded-100 py-4 text-center col-6 text-14 fw-500 bg-red-3 text-red-2">Cancelado</div></td>';
                                    break;
                                  ...
                                  case 'DELIVERED':
                                    echo '<td class="d-flex justify-center"><div class="col-12 rounded-100 py-4 text-center col-6 text-14 fw-500 bg-success-2 text-white">Entregado</div></td>';
                                    break;

                                  case 'RETURNED':
                                    echo '<td class="d-flex justify-center"><div class="col-12 rounded-100 py-4 text-center col-6 text-14 fw-500 bg-yellow-4 text-yellow-3">Devuelto</div></td>';
                                    break;
                                } ?>
                                <td>
                                  <div onclick="showDetails('<?= $idCarrito ?>')" style="border-radius: 10px !important; cursor: pointer;" class="px-4 py-10 text-center col-12 text-14 fw-500 bg-dark-1 text-white">Ver detalles</div>
