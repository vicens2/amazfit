      ...
      <div class="container">
        <div class="row justify-center">
          <div class="col-xl-6 col-lg-7 col-md-9">
            <div class="px-50 py-50 sm:px-20 sm:py-20 bg-white shadow-2 rounded-xl">
              <div class="row y-gap-20">
                <div class="col-12">
                  <h1 class="text-22 fw-500">Acceso para Clientes</h1>
                </div>
                ...
                <div class="col-12">
                  <a href="#" class="text-14 fw-500 text-blue-1 underline">¿Ha olvidado su contraseña?</a>
                </div>
              ...
              <div class="row y-gap-5 pt-30">
                <div class="col-12">
                  ...
                  <a href="../BD241615038B/signup_pro.php" class="button py-15  bg-dark-1 text-white rounded-4 mt-2">
...
<script>
  ...
  function loginUser() {
    ...
    if (!user) {
      alertify.error("Por favor, ingrese una dirección de correo electrónico", 3);
      return;
    }
    if (esCorreoElectronicoValido(user) === false) {
    ...
    $.post('userLogin.php', {
      ...
      function(data) {
        ...
        if (JSON.parse(data).user === "UserNotFound") {
          alertify.error("El email o la contraseña son incorrectos", 3);
